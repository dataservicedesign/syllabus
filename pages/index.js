...
export default function Home({ allPostsData }) {
  return (
    ...
    <Head>
    <title>bndndr, Andrea Benedetti</title>
    <meta name="title" content="bndndr, Andrea Benedetti" key="title" />
    <meta name="description" content="Design portfolio of Andrea Benedetti, researcher and practitioner." key="description" />
    
    <meta property="og:type" content="website" key="og:type"/>
    <meta property="og:url" content="https://www.bndndr.it/" key="og:url"/>
    <meta property="og:title" content="bndndr, Andrea Benedetti" key="og:title"/>
    <meta property="og:description" content="Design portfolio of Andrea Benedetti, researcher and practitioner." key="og:description"/>
    <meta property="og:image" content="/og-image.png" key="og:image"/>
    
    <meta property="twitter:card" content="summary_large_image" key="twitter:card"/>
    <meta property="twitter:url" content="https://www.bndndr.it/" key="twitter:url"/>
    <meta property="twitter:title" content="bndndr, Andrea Benedetti" key="twitter:title"/>
    <meta property="twitter:description" content="Design portfolio of Andrea Benedetti, researcher and practitioner." key="twitter:description"/>
